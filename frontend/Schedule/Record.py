...
class TimeFrame(ctk.CTkFrame):
    def __init__(self, parent, schedule, i, j, current_time):
    ...
    def create_widgets(self):
        ...
        if len(self.schedule) > 0:
            ...
            self.button_update = ctk.CTkButton(self, text='u', width=26, height=26)
            ...
            self.label_time.grid(row=0, column=0, sticky='w', padx=(5, 5))
            self.button_create = ctk.CTkButton(self, text='+', width=26, height=26)
